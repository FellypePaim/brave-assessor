...
// ─── SQL completo para recriar todas as tabelas ───
...
CREATE TYPE public.subscription_plan AS ENUM ('free', 'mensal', 'trimestral', 'anual', 'teste');

-- 2. TABELAS (ordem respeitando dependências)
...
-- 4. TRIGGERS (em auth.users — execute no SQL Editor do Supabase)
...
-- whatsapp_pending_transactions (service role only)
...
-- whatsapp_rate_limits (no RLS policies — accessed by functions with SECURITY DEFINER)
