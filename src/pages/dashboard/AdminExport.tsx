...
const FULL_SCHEMA_SQL = [
  ...
  "",
  "-- 6. RLS POLICIES (com DROP IF EXISTS para idempotência)",
  "",
  "-- profiles",
  ...
  "DROP POLICY IF EXISTS \"Family can view wallets\" ON public.wallets;",
  ...
  "DROP POLICY IF EXISTS \"Family can view goals\" ON public.financial_goals;",
  ...
  "DROP POLICY IF EXISTS \"Members can view groups they belong to\" ON public.family_groups;",
  ...
  "DROP POLICY IF EXISTS \"Users can insert own membership\" ON public.family_memberships;",
  ...
  "DROP POLICY IF EXISTS \"Users can create own conversations\" ON public.support_conversations;",
  ...
  "",
  "-- support_messages",
  "DROP POLICY IF EXISTS \"Users can view own conversation messages\" ON public.support_messages;",
