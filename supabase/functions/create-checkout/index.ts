...
// Mapeamento de plano → price_id do Stripe
const PLAN_PRICES: Record<string, string> = {
  mensal: "price_1T2271FQmz22ylYMQrYyktHi",
  anual: "price_1T227EFQmz22ylYM3VNyp1sS",
};
...
serve(async (req) => {
  ...
  try {
    ...
    // Verifica se já existe cliente Stripe para este e-mail
    ...
    console.log(`Checkout criado para user=${user.id} plano=${plan} session=${session.id}`);
